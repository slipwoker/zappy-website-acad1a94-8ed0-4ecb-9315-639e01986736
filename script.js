document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      if ((type === 'tel' || name === 'phone') && !validators.phone(value)) {
  ...
  if (animatedElements.length > 0) {
    ...
    styleTag.textContent = [
      ...
      '}',
      '.animate-hidden.fade-in-down {',
      '  transform: translateY(-24px);',
      '}',
      '.animate-hidden.fade-in-left {',
      '  transform: translateX(24px);',
      '}',
      '.animate-hidden.fade-in-right {',
      '  transform: translateX(-24px);',
      '}',
      '.animate-visible {',
      '  opacity: 1 !important;',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'acad1a94-8ed0-4ecb-9315-639e01986736',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'acad1a94-8ed0-4ecb-9315-639e01986736';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'acad1a94-8ed0-4ecb-9315-639e01986736';
